...
import { ManageCoursePage } from '../ManageCoursePage'; // named export to avoid the connect() wrapped component
...
function render(args) {
    const defaultProps = {
        ...
        // Could also use MemoryRouter as shown in Header.Enzyme.test.js,
